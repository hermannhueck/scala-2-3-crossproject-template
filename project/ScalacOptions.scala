...
object ScalacOptions {
  ...
  lazy val scalac3Options = Seq.empty[String]

  def defaultScalacOptions(scalaVersion: String): Seq[String] =
  ...
  lazy val consoleScalacOptions = scalac213Options.diff(filterConsoleScalacOptions)
}
